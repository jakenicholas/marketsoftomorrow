...
.rel-card{display:grid;grid-template-columns:230px 1fr;gap:22px;align-items:stretch;border:1px solid var(--hair);border-radius:18px;overflow:hidden;background:linear-gradient(180deg,rgba(167,139,250,.035),transparent 60%);transition:border-color .2s,transform .2s,box-shadow .2s}
.rel-card:hover{border-color:rgba(167,139,250,.42);transform:translateY(-2px);box-shadow:0 24px 60px -30px rgba(167,139,250,.5)}
.rel-card .rc-media{position:relative;overflow:hidden;background:#111;aspect-ratio:16/10;align-self:center;border-radius:12px;margin:14px 0 14px 14px}
.rel-card .rc-media img{width:100%;height:100%;object-fit:contain;background:#0b0d10;display:block;transition:transform .5s ease}
...
@media(max-width:620px){.rel-card{grid-template-columns:1fr}.rel-card .rc-media{aspect-ratio:16/9;margin:14px 14px 0}.rel-card .rc-body{padding:0 22px 24px}}
