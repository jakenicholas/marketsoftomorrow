...
(function () {
  ...
  function injectCSS() {
    ...
    var css = [
      ...
      '.tmw-pcard .pc-badge{position:absolute; top:18px; left:18px; z-index:2; font-family:"JetBrains Mono",monospace; font-size:10px; letter-spacing:.18em; text-transform:uppercase; font-weight:700; color:var(--gs); padding:8px 14px; border-radius:999px; background:rgba(7,8,7,.5); -webkit-backdrop-filter:blur(8px); backdrop-filter:blur(8px); border:1px solid rgba(230,197,116,.55)}',
      ...
      '.tmw-pcard .pc-flyover .lbl{position:absolute; right:calc(100% + 8px); top:50%; transform:translateY(-50%); font-family:"JetBrains Mono",monospace; font-size:9px; letter-spacing:.1em; text-transform:uppercase; color:var(--cream); background:rgba(7,8,7,.75); padding:5px 9px; border-radius:6px; white-space:nowrap; opacity:0; transition:opacity .18s; pointer-events:none}',
      ...
      '.tmw-pcard .pc-pct{font-family:"JetBrains Mono",monospace; font-size:10.5px; color:var(--mute2)}',
      ...
      '.tmw-pcard .pc-phases{display:flex; justify-content:space-between; margin-top:8px; font-family:"JetBrains Mono",monospace; font-size:8px; letter-spacing:.05em; text-transform:uppercase; color:var(--mute)}',
      '.tmw-pcard .pc-phases span.on{color:var(--or)}',
      '.tmw-pcard .pc-delivery{font-family:"JetBrains Mono",monospace; font-size:10px; letter-spacing:.06em; text-transform:uppercase; color:var(--mute2); margin-top:10px}',
      ...
      '.tmw-pcard .pc-stat .l{display:block; font-family:"JetBrains Mono",monospace; font-size:9px; letter-spacing:.14em; text-transform:uppercase; color:var(--mute); margin-top:6px}',
      ...
      '.tmw-pcard .pc-btn{display:inline-flex; align-items:center; gap:8px; font-family:"JetBrains Mono",monospace; font-size:11px; letter-spacing:.12em; text-transform:uppercase; font-weight:700; padding:13px 22px; border-radius:11px; text-decoration:none; cursor:pointer; transition:all .18s}',
