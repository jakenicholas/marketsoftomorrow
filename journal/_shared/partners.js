...
(function () {
  ...
  if (!document.getElementById('tmw-partners-styles')) {
    const css = `
      ...
      .tmw-partner-card{background:rgba(255,255,255,.025); border:1px solid rgba(255,255,255,.08); border-radius:16px; overflow:hidden; display:flex; flex-direction:column; transition:transform .25s ease, border-color .25s ease, background .25s ease}
      .tmw-partner-card:hover{transform:translateY(-3px); border-color:rgba(31,223,103,.4); background:rgba(31,223,103,.05)}
