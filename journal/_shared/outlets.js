...
(function () {
  ...
  function sectionHtml(eyebrow) {
    return '<section class="tmw-outlets">'
      ...
      +   '<p class="tmo-lede">Markets of Tomorrow is a real-time journal and data platform tracking the world\'s most significant new developments in hospitality, residential, golf, and dining. We amass over <span class="g">10 million views monthly</span>, with focus markets in Florida, New York, Tennessee, the Caribbean, and the Rockies, plus <span class="g">Hotels of Tomorrow</span>, our global travel arm.</p>'
      +   '<div class="tmo-umb">'
      +     '<div class="tmo-umb-left">'
      +       '<div class="tmo-umb-lab">Markets of Tomorrow &middot; Umbrella Total</div>'
      +     '</div>'
      +     '<div class="tmo-umb-stats">'
      +       '<div class="tmo-us tmo-us-foll"><span class="tmo-uv" data-fk="umbrella">205K</span><span class="tmo-uk">Followers</span></div>'
      +       '<div class="tmo-us"><span class="tmo-uv">10.2M</span><span class="tmo-uk">Mo. Social</span></div>'
      +       '<div class="tmo-us"><span class="tmo-uv">1.1M</span><span class="tmo-uk">Mo. Web</span></div>'
