...
PAYWALL_BODY_JS = """  <script>
    (function () {
      ...
      function setupLoadMore() {
        ...
        locked.parentNode.insertBefore(btn, locked.nextSibling);
        tick();
      }
...
<head>
  ...
  <style>
    ...
    *, *::before, *::after {{ box-sizing: border-box; margin: 0; padding: 0; }}
    ...
    .btn-grid {{ display: grid; width:100%; grid-template-columns: repeat(5, minmax(0,1fr)); gap: 10px; }}
    @media (max-width: 980px) {{ .btn-grid {{ grid-template-columns: repeat(3, minmax(0,1fr)); }} }}
    @media (max-width: 560px) {{ .btn-grid {{ grid-template-columns: repeat(2, minmax(0,1fr)); }} }}
