...
<head>
  ...
  <style>
    body > div[id^="ms-"],
    body > div[class*="ms-"],
    body > div[data-ms-modal],
    body > [role="dialog"],
    #ms-overlay, #ms-modal-overlay, [id^="ms-modal"] {{
      background: rgba(0,0,0,0.78) !important;
      backdrop-filter: blur(8px) !important;
      -webkit-backdrop-filter: blur(8px) !important;
    }}
    body > div[id^="ms-"] > div,
    body > div[class*="ms-"] > div,
    body > div[data-ms-modal] > div,
    body > div[id^="ms-"] [role="dialog"],
    body > [role="dialog"] {{
    ...
    body > div[id^="ms-"] h1, body > div[id^="ms-"] h2, body > div[id^="ms-"] h3,
    body > div[class*="ms-"] h1, body > div[class*="ms-"] h2,
    body > [role="dialog"] h1, body > [role="dialog"] h2 {{
      color: #fff !important;
    }}
    body > div[id^="ms-"] p, body > div[id^="ms-"] small,
    body > div[class*="ms-"] p, body > [role="dialog"] p {{
      color: rgba(255,255,255,0.7) !important;
    }}
    body > div[id^="ms-"] label,
    body > div[class*="ms-"] label,
    body > [role="dialog"] label {{
      color: #fff !important;
      font-weight: 600 !important;
      font-size: 13px !important;
    }}
    body > div[id^="ms-"] input,
    body > div[id^="ms-"] textarea,
    body > div[id^="ms-"] select,
    body > div[class*="ms-"] input,
    body > div[class*="ms-"] textarea,
    ...
    body > div[id^="ms-"] input:focus,
    body > div[id^="ms-"] textarea:focus,
    body > div[class*="ms-"] input:focus,
    ...
    body > div[id^="ms-"] input::placeholder,
    body > div[class*="ms-"] input::placeholder,
    body > [role="dialog"] input::placeholder {{
      color: rgba(255,255,255,0.35) !important;
      opacity: 1 !important;
    }}
    body > div[id^="ms-"] button[aria-label*="assword"],
    body > div[class*="ms-"] button[aria-label*="assword"] {{
    ...
    body > div[id^="ms-"] button[aria-label*="assword"]:focus,
    body > div[class*="ms-"] button[aria-label*="assword"]:focus {{
      outline: none !important;
      box-shadow: 0 0 0 2px rgba(31,223,103,0.5) !important;
      border-radius: 6px !important;
    }}
    body > div[id^="ms-"] button[type="submit"],
    body > div[class*="ms-"] button[type="submit"],
    body > [role="dialog"] button[type="submit"],
    body > div[id^="ms-"] button[class*="primary"],
    body > [role="dialog"] button[class*="primary"] {{
    ...
    body > div[id^="ms-"] button[type="submit"]:hover,
    body > [role="dialog"] button[type="submit"]:hover {{
      background: #18c75a !important;
    }}
    body > div[id^="ms-"] button:not([type="submit"]):not([class*="primary"]):not([aria-label*="lose"]):not([aria-label*="assword"]),
    body > [role="dialog"] button:not([type="submit"]):not([class*="primary"]):not([aria-label*="lose"]):not([aria-label*="assword"]) {{
    ...
    body > div[id^="ms-"] button[aria-label*="lose"],
    body > [role="dialog"] button[aria-label*="lose"] {{
      color: rgba(255,255,255,0.5) !important;
      background: transparent !important;
      border: none !important;
      box-shadow: none !important;
    }}
    body > div[id^="ms-"] nav button,
    body > div[id^="ms-"] [class*="sidebar"] button {{
      color: #fff !important;
      background: transparent !important;
      border: none !important;
      text-align: left !important;
    }}
    body > div[id^="ms-"] nav button[aria-current="true"],
    body > div[id^="ms-"] nav button.active {{
      background: rgba(31,223,103,0.10) !important;
      color: #1FDF67 !important;
      border-radius: 8px !important;
    }}
    body > div[id^="ms-"] [class*="error"],
    body > div[class*="ms-"] [class*="error"],
    body > [role="dialog"] [role="alert"] {{
  ...
  <style>
    *, *::before, *::after {{ box-sizing: border-box; margin: 0; padding: 0; }}
    ...
    /* ── Project Updates: timeline of status_change + new_project events ── */
    .updates-section[hidden] {{ display: none; }}
    .updates-section {{ margin-top: 28px; padding-top: 22px; border-top: 1px solid rgba(255,255,255,0.08); }}
    .updates-header {{ display: flex; align-items: center; justify-content: space-between; margin-bottom: 14px; }}
    .updates-title {{ font-size: 12px; text-transform: uppercase; letter-spacing: 0.1em; font-weight: 700; color: #fff; margin: 0; display: flex; align-items: center; gap: 8px; }}
    .updates-count {{ font-size: 10px; background: rgba(31,223,103,0.12); color: #1FDF67; padding: 2px 7px; border-radius: 10px; font-weight: 700; letter-spacing: 0.04em; }}
    .update-row {{ display: flex; gap: 12px; padding: 10px 0; border-bottom: 1px solid rgba(255,255,255,0.05); }}
    .update-row:last-child {{ border-bottom: none; }}
    .update-dot {{ flex-shrink: 0; width: 8px; height: 8px; margin-top: 6px; border-radius: 50%; background: #FF9500; }}
    .update-dot.map {{ background: #6FA8FF; }}
      ...
      fetch('/pulse.json', {{ cache: 'no-store' }})
        ...
        .then(function(data) {{
          ...
          var matches = events.filter(function(ev) {{
            return ev.project_slug === pageSlug &&
                   (ev.type === 'status_change' || ev.type === 'new_project');
          }});
          if (!matches.length) {{
          ...
          matches.forEach(function(ev) {{
            var dotCls = (ev.type === 'new_project') ? 'map' : '';
            var text = ev.title_full || ev.title || 'Project update';
            html += '<div class="update-row">' +
                      '<div class="update-dot ' + dotCls + '"></div>' +
                      '<div class="update-body">' +
                        '<div class="update-text">' + escapeHtml(text) + '</div>' +
                        '<div class="update-meta">' + escapeHtml(formatDate(ev.timestamp)) + '</div>' +
                      '</div>' +
                    '</div>';
          }});
          body.innerHTML = html;
