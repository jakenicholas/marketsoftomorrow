    ...
    return f'''
      <div class="pp-sec ai-sec" id="atlasIntel" data-slug="{html.escape(slug)}" data-supply="{supply_level}">
        <style>
          ...
          .ai-kicker{{font-size:11px;letter-spacing:.16em;text-transform:uppercase;color:var(--ai-muted2);font-weight:600;margin-bottom:14px;display:flex;align-items:center;gap:10px}}
          ...
          .ai-card{{background:var(--ai-panel);border:1px solid var(--ai-stroke);border-radius:20px;padding:24px;position:relative;overflow:hidden;margin-bottom:18px}}
          ...
          .ai-gate{{display:flex;align-items:center;justify-content:space-between;gap:12px;margin-top:18px;padding:13px 16px;border:1px solid rgba(167,139,250,.3);background:var(--ai-purple-dim);border-radius:13px}}
