...
- 1. Name and save a comparison view (persisted to Memberstack JSON)
- 1. Manage saved comparisons (rename, delete)
- 
...
<button type="button" class="compare-modal-close" aria-label="Close" data-close="1">×</button>
</header>
...
viewEl.innerHTML = `<div class="compare-view-map" id="compareViewMap"></div> <div class="compare-view-cards-wrap"> <div class="compare-view-cards" role="list"></div> </div> <footer class="compare-view-footer"> <button type="button" class="compare-view-back" aria-label="Close comparison"> <svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="19" y1="12" x2="5" y2="12"/><polyline points="12 19 5 12 12 5"/></svg> </button> <div class="compare-view-titles"> <h1 class="compare-view-title"></h1> <div class="compare-view-sub"></div> </div> <div class="compare-view-actions"> <button type="button" class="compare-view-action" data-view-action="edit" aria-label="Edit comparison" title="Edit"> <svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"/><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"/></svg> </button> <button type="button" class="compare-view-action" data-view-action="share" aria-label="Share comparison" title="Share"> <svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 12v8a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-8"/><polyline points="16 6 12 2 8 6"/><line x1="12" y1="2" x2="12" y2="15"/></svg> </button> </div> </footer>`;
